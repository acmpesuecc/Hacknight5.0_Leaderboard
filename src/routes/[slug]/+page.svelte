    ...
    <body>
        ...
        <div class="flex justify-center items-center my-12">
            <div class="image-container">
                ...
                <img src="https://github.com/{user_details[0].Contributor_name}.png" alt="" class="rounded-md w-32 h-auto mr-12 overlay-image">
            </div>              
            <a href="https://github.com/{user_details[0].Contributor_name}" class="text-2xl md:text-2xl lg:text-5xl text-[#EFEDEF] font-bold m-4 mb-1 lg:m-4 md:mb-3" target="_blank">
        ...
        <div class="bg-[#0F0913] m-4 lg:m-10 pt-2 pb-2">
            {#each user_details as user}
                <div class="card p-6 block md:grid md:grid-cols-3 md:justify-center md:items-center text-center">
                    <p class="text-5xl my-auto pb-2 md:pb-0">{user.Points_allotted}</p>
                    <div>
                        <a href="https://github.com/{user.Maintainer_name}" class="deets" target="_blank">Maintainer: {user.Maintainer_name}</a>
